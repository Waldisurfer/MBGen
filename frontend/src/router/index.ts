...
{ path: '/dashboard', component: () => import('@/views/DashboardView.vue'), meta: { requiresAuth: true } },
    ...
    { path: '/brands', component: () => import('@/views/BrandLibraryView.vue'), meta: { requiresAuth: true } },
    { path: '/audiences', component: () => import('@/views/AudienceLibraryView.vue'), meta: { requiresAuth: true } },
...
router.beforeEach(async (to) => {
  ...
  // Always wait for the initial auth check (no-op after first call).
  await auth.init();
